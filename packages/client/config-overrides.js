...
var fs = require('fs');
const { override, babelInclude, fixBabelImports, overrideDevServer } = require('customize-cra');
...
module.exports = function(config, env) {
  return Object.assign(
    ...
    override(
      ...
      overrideDevServer('allowedHosts', [
        'dev.nvcorp.net'
      ]),
      overrideDevServer('https', true),
      overrideDevServer('disableHostCheck', true)
    )(config, env)
  );
};
